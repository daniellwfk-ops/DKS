    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-10">
                ...
                >
                    <div className="text-3xl mb-4">🔗</div>
                    <h2 className="text-white font-black mb-1">Link na Bio</h2>
                    <p className="text-[#888] text-sm">Customize o cartão de links do Instagram (Linktree) da DKS Marketing.</p>
                    <span className="inline-block mt-4 text-[#D4AF37] text-xs font-bold">Abrir ferramenta →</span>
                </Link>
