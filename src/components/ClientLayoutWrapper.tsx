...
const CLEAN_LAYOUT_ROUTES = ["/apresentacao", "/podcast", "/apresentacao2", "/apresentacao3", "/prospect", "/daianipauli", "/bublitz", "/bublitz-explicativa", "/decopizzas", "/v2", "/apresentacaotiodorp", "/login", "/cadastro", "/admin", "/portal", "/bio", "/princeso"];
