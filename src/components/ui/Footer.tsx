...
const socialLinks = [
    {
        label: "Instagram",
        href: "https://www.instagram.com/odanielssoares/",
        icon: (
    ...
    {
        label: "WhatsApp",
        href: "https://wa.me/55047991620354",
        icon: (
    ...
    {
        label: "Email",
        href: "mailto:contatoagenciadks@gmail.com",
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            <li>
                                <a
                                    href="mailto:contatoagenciadks@gmail.com"
                                    className="flex items-center gap-3 text-[#666] hover:text-[#D4AF37] transition-colors duration-200 group"
                                >
                                    <span className="w-8 h-8 rounded-lg bg-[#D4AF37]/10 border border-[#D4AF37]/20 flex items-center justify-center flex-shrink-0 group-hover:bg-[#D4AF37]/20 transition-colors">
